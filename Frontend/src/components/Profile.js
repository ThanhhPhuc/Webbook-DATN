...
const Profile = () => {
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            setUser(response.data.user); // Cập nhật `user` trong AuthContext
                                                                                            ...
                                                                                            <div className="account-details-form">
                                                                                                <form onSubmit={handleUpdateProfile}>
                                                                                                    <div className="row">
                                                                                                        ...
                                                                                                        <div className="col-lg-6 col-12 mb-30">
                                                                                                            <input id="last-name" placeholder="Số điện thoại" type="text" value={phone} onChange={(e) => setPhone(e.target.value)} />
                                                                                                        </div>
                                                                                                        <div className="col-12 mb-30">
                                                                                                            <input id="display-name" placeholder="Địa chỉ" type="text" value={address} onChange={(e) => setAddress(e.target.value)} />
                                                                                                        </div>
                                                                                                        <div className="col-12 mb-30">
                                                                                        ...
                                                                                        <div className="myaccount-content">
                                                                                            ...
                                                                                            <div className="myaccount-table table-responsive text-center">
                                                                                                <table className="table table-bordered">
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        {/* Dữ liệu đặt hàng sẽ được hiển thị ở đây */}
                                                                                                    </tbody>
                                                                                                </table>
                                                                                            </div>
                                                                                        </div>
