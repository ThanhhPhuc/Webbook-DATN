...
//         e.preventDefault();
//         // Xử lý thanh toán và chuyển sang trang thành công
//         navigate('/paymentsuccess');
//     };

//     // Kiểm tra nếu các trường bắt buộc đã đầy đủ
...
//                 {/* Ẩn nút thanh toán nếu thông tin chưa đủ */}
//                 {isFormValid ? (
//                     <button type="submit" className="checkout-button">Xác nhận thanh toán</button>
//                 ) : (
//                     <p className="warning-message">Vui lòng điền đầy đủ thông tin để tiếp tục.</p>
//                 )}
//             </form>
//         </div>
//     );
...
//         try {
//             // Gửi dữ liệu đơn hàng lên API backend
//             const response = await axios.post('http://localhost:5000/api/order/create', orderData);
            
//             // Nếu tạo đơn hàng thành công, chuyển hướng tới trang thanh toán thành công
